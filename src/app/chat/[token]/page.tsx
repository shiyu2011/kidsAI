    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">Your AI learning coach</p>
        </div>
      </header>
          ...
          {messages.length === 0 && (
            <div className="text-center py-12">
              ...
              <h2 className="text-xl font-semibold text-gray-900 mb-2">
                Hi! I&apos;m SeanSean, your learning coach
              </h2>
              <p className="text-gray-500 mb-8 max-w-md mx-auto">
                Ask me anything — math, science, coding, writing. I won&apos;t just give you
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {suggestionsReady && suggestions.map((s) => (
                  <button
                    ...
                    className="px-4 py-2 bg-white border border-gray-200 rounded-full text-sm text-gray-700 hover:bg-blue-50 hover:border-blue-300 transition flex items-center gap-2"
                  >
                    <span>{s.icon}</span>
                    {s.label}
                  </button>
